  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center p-3">
        ...
        <span
          className={`text-lg font-bold ${colorSet.text} px-2 py-1 justify-self-center rounded-lg mt-1 hover:scale-110 transition-all duration-300 cursor-pointer`}
        >
          {remainingStock} Lembar
        </span>
      </div>
      <div
        className={`flex flex-col items-center min-w-[318px] mx-5 text-gray-700 rounded-lg p-3 ${colorSet.type}`}
      >
        ...
        <div className="flex justify-between items-center p-2 w-full hover:scale-105 transition-all duration-300 cursor-pointer">
          ...
          <span className="ml-2 text-sm hover:text-emerald-600 hover:scale-110 transition-all duration-300 cursor-pointer">
            Rp.{priceColorOneSide.toLocaleString()},00/lbr
          </span>
        </div>
        <div className="flex justify-between items-center p-2 w-full hover:scale-105 transition-all duration-300 cursor-pointer">
          <div className="flex items-center">
